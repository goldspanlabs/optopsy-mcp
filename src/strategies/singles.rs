use super::helpers::{call_leg, default_delta, put_leg, strategy, Side, StrategyDef};
...
pub fn long_call() -> StrategyDef {
    strategy(
        ...
        "Singles",
        "Buy a call option",
        vec![call_leg(Side::Long, 1, default_delta())],
    )
}
...
pub fn short_call() -> StrategyDef {
    strategy(
        ...
        "Singles",
        "Sell a call option",
        vec![call_leg(Side::Short, 1, default_delta())],
    )
}
...
pub fn long_put() -> StrategyDef {
    strategy(
        ...
        "Singles",
        "Buy a put option",
        vec![put_leg(Side::Long, 1, default_delta())],
    )
}
...
pub fn short_put() -> StrategyDef {
    strategy(
        ...
        vec![put_leg(Side::Short, 1, default_delta())],
    )
}
