...
use crate::engine::types::{
    Commission, CompareResult, ConflictResolution, DteRange, EquityPoint, ExpirationFilter,
    PerformanceMetrics, Side, SizingConfig, Slippage, SweepResult, TargetRange, TradeRecord,
    TradeSelector,
};
...
pub struct FactorExposure {
    ...
    pub is_significant: bool,
    /// Contribution to total return (beta × factor mean return)
